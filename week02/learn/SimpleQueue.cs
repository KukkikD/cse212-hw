public class SimpleQueue {
    ...
    private void Enqueue(int value) {
        _queue.Add(value); //Defect 2 enqueue to back, no need index
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; //Defect 1  Get front value : index(0)
        _queue.RemoveAt(0); // dequeue from front : index(0)
        return value;
    }
}