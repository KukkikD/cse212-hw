public class Translator
{
    ...
    {
        _words[fromWord] = toWord;  //If there is no key, Add a new one
                                    //If there is an existing key,Replace the translation
    }
    ...
    {
        if (_words.ContainsKey(fromWord)) //If there is key, translate
        {
